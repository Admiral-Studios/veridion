...
const navigation = (): VerticalNavItemsType => {
  return [
    { title: 'Home', icon: 'solar:home-outline', subject: SubjectTypes.HomePage, action: 'read', path: '/home' },
    {
      ...
      subject: SubjectTypes.VeridionData,
      action: 'read',
      children: [
        {
          title: 'Coverage',
        ...
        },
        {
          ...
          children: [
            ...
            {
              title: 'News',
              path: '/dashboard/esg_news',
              subject: SubjectTypes.DashboardESGNews,
              action: 'read'
            }
          ]
        }
    ...
    {
      title: 'Veridion Services',
      icon: 'carbon:web-services-cluster',
      subject: SubjectTypes.VeridionServices,
      action: 'read',
      children: [
        {
